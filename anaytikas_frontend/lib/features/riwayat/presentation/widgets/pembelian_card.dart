...
import 'package:anaytikas_frontend/features/riwayat/presentation/pages/detail_riwayat_pembelian_page.dart';
import 'package:flutter/material.dart';

class PembelianCard extends StatelessWidget {
  final RiwayatPembelian data;
  const PembelianCard({super.key, required this.data});
      ...
      child: InkWell(
        onTap: () {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => DetailRiwayatPembelianPage(pembelian: data),
            ),
          );
        },
        child: Column(
